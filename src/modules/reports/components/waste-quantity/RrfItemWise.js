...
function RrfItemWise() {
    ...
    let report = {
        head: getReportInfo('rrf_item_wise'),
    ...
    let ExportArray = [];
    if (hasAccessPermission(RESOURCE_MAPPING.REPORT_ITEM_WISE_RRF, ACTION_MAPPING.REPORT_ITEM_WISE_RRF.TABLE_COLUMN)) {
        viewColumnFlag = true;
    }
    if (hasAccessPermission(RESOURCE_MAPPING.REPORT_ITEM_WISE_RRF, ACTION_MAPPING.REPORT_ITEM_WISE_RRF.TABLE_FILTER)) {
        filterFlag = true;
    }
    if (hasAccessPermission(RESOURCE_MAPPING.REPORT_ITEM_WISE_RRF_EXPORT, ACTION_MAPPING.REPORT_ITEM_WISE_RRF_EXPORT.PDF)) {
        report.pdf = getPdfTableData({ columns, data: data });
    }
    if (hasAccessPermission(RESOURCE_MAPPING.REPORT_ITEM_WISE_RRF_EXPORT, ACTION_MAPPING.REPORT_ITEM_WISE_RRF_EXPORT.EXCEL)) {
        report.excel = getExcelTableData({ columns, data: data });
    }
    if (hasAccessPermission(RESOURCE_MAPPING.REPORT_ITEM_WISE_RRF, ACTION_MAPPING.REPORT_ITEM_WISE_RRF.TABLE_EXPORT)) {
