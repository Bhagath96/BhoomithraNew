...
import { formatResourceActionsCheckBox } from '../../utils/PermissionUtils';
...
const formatDataAccess = (data) => {
    let dataAccessArray = [];
    data.forEach(item => {
        dataAccessArray = [...dataAccessArray, ...item?.dataCaptureViewResponses];
    });
    let formatObj = _.map(dataAccessArray, item => {
        const { dataCaptureView, noOfData, multiData, dataAccess, id } = item;
        return {
            noOfData, multiData, id,
            dataCaptureView: dataCaptureView.id,
            dataAccessId: dataAccess
        };

    });
    let response = _.groupBy(formatObj, 'dataCaptureView');
    return response;
};
const initialState = {
    addUser: {
...
let organizationRolesResponse = {}, regularRolesResponse = {}, resourceActionPayload = {};
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ActionTypes.LIST_REGULAR_ROLE_SUCCESS:
            ...
            return Object.assign({}, state, {
                listRegularRoles: {
                    ...
                    pageSize: _.get(regularRolesResponse, 'pageable.pageSize', 10),
                    pageNo: _.get(regularRolesResponse, 'pageable.pageNumber', 0),
                    totalCount: _.get(regularRolesResponse, 'totalElements', 0),
                    requestInProgress: false,
        ...
        //to delete an organisational role
        case ActionTypes.DELETE_ORGANISATIONAL_ROLE_REQUEST:
            return Object.assign({}, state, {
                deleteOrganizationRole: {
        ...
        case ActionTypes.DELETE_ORGANISATIONAL_ROLE_SUCCESS:
            return Object.assign({}, state, {
                deleteOrganizationRole: {
        ...
        case ActionTypes.DELETE_ORGANISATIONAL_ROLE_FAILURE:
            return Object.assign({}, state, {
                deleteOrganizationRole: {
                    ...state.deleteOrganizationRole,
                    requestInProgress: false,
        ...
        case ActionTypes.SET_DATA:
            resourceActionPayload = action.payload?.data;
            return Object.assign({}, state, {
                resourceActions: {
                    ...initialState.resourceActions,
                    ...state.resourceActions,
                    [_.get(resourceActionPayload, 'type', '')]: getPayloadData(action.payload, {})
                }
            });
        //for updating role
        ...
        case ActionTypes.GET_ROLE_PERMISSION_FOR_EDIT_SUCCESS:
            return Object.assign({}, state, {
                getrolePermissionsForEdit: {
                    requestInProgress: false,
                    data: convertingResourceArray(getPayloadData(action.payload, {})),
                    actionIds: toGetActionIds(getPayloadData(action.payload, {})),
                    resourcePermissionId: toGetResourcePermissionId(getPayloadData(action.payload, {})),
        ...
        case ActionTypes.FETCH_RESOURCE_ACTIONS_SUCCESS:
            return Object.assign({}, state, {
                ...
                resourceActions: {
                    ...initialState.resourceActions,
                    ...state.resourceActions,
                    ...formatResourceActionsCheckBox(getPayloadData(action.payload, {}))
                }
        ...
        case ActionTypes.FETCH_VIEWS_REQUEST:
            return Object.assign({}, state, {
                listDataAccessViews: {
                    ...initialState.listDataAccessViews,
                    requestInProgress: true
                }
            });
        ...
        case ActionTypes.FETCH_VIEWS_FAILURE: {
            return Object.assign({}, state, {
                listDataAccessViews: {
                    ...state.listDataAccessViews
                }
            });
        }
        case ActionTypes.FETCH_LEVELS_REQUEST:
            return Object.assign({}, state, {
                listDataAccess: {
                    ...initialState.listDataAccess,
                    requestInProgress: true
                }
            });
        ...
        case ActionTypes.FETCH_LEVELS_FAILURE: {
            return Object.assign({}, state, {
                listDataAccess: {
                    ...state.listDataAccess
                }
            });
        }
        case ActionTypes.FETCH_CONFIG_DATA_ACCESS_BY_ID_REQUEST:
            return Object.assign({}, state, {
                dataAccessGetById: {
                    ...initialState.dataAccessGetById,
                    requestInProgress: true
                }
            });
        case ActionTypes.FETCH_CONFIG_DATA_ACCESS_BY_ID_SUCCESS: {
            return Object.assign({}, state, {
                dataAccessGetById: {
                    requestInProgress: false,
                    data: formatDataAccess(getPayloadData(action.payload, {}))
                }
            });
        }
        case ActionTypes.FETCH_CONFIG_DATA_ACCESS_BY_ID_FAILURE: {
            return Object.assign({}, state, {
                dataAccessGetById: {
                    ...state.dataAccessGetById
                }
            });
        }
        default:
