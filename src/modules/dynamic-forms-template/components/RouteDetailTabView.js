                ...
                <div className={classes.root}>
                    <AppBar position="static" className={classes.colorPrimary}>
                        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example">
                            {
                                hasAccessPermission(RESOURCE_MAPPING.TEMPLATE_ROUTE_DETAILS, ACTION_MAPPING.TEMPLATE_ROUTE_DETAILS.ACCESS_IN_TAB) || false &&
...
export default RouteDetailTabView;
