...
function UserGroupMainPageViews() {
    ...
    if (hasAccessPermission(RESOURCE_MAPPING.USER_GROUP_DETAILS, ACTION_MAPPING.USER_GROUP_DETAILS.ACCESS_IN_TAB) || false) {
        userGroupTabArray.push({ name: 'details', label: 'details', component: <AddUserGroup /> });
    }
    if (hasAccessPermission(RESOURCE_MAPPING.USER_GROUP_ASSIGN_USER, ACTION_MAPPING.USER_GROUP_ASSIGN_USER.ACCESS_IN_TAB) || false) {
