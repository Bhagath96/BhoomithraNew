...
import { resetFormChange, setFormChange } from '../../../common/actions';
...
function AssignWorker(props) {
    ...
    useEffect(() => {
        dispatch(Actions.getAssignWorkers(id));
...
export default connect(state => ({
    initialValues: state[STATE_REDUCER_KEY].getAssignedWokers.data
}))(reduxForm({
