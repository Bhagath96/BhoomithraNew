...
export const types = {
    ...
    FORCE_UPDATE_SURVEY_TEMPLATES: 'Dfg/FORCE_UPDATE_SURVEY_TEMPLATES',
    ...
    SET_RESUME_MODAL_VISIBILITY: 'Dfg/SET_RESUME_MODAL_VISIBILITY',
...
export const webTypes = {
    FETCH_SURVEY_TEMPLATE_VERSION_REQUEST: 'Dfg/FETCH_SURVEY_TEMPLATE_VERSION_REQUEST',
    FETCH_SURVEY_TEMPLATE_VERSION_SUCCESS: 'Dfg/FETCH_SURVEY_TEMPLATE_VERSION_SUCCESS',
    FETCH_SURVEY_TEMPLATE_VERSION_FAILURE: 'Dfg/FETCH_SURVEY_TEMPLATE_VERSION_FAILURE',

    FETCH_SINGLE_SURVEY_TEMPLATE_REQUEST: 'Dfg/FETCH_SINGLE_SURVEY_TEMPLATE_REQUEST',
    FETCH_SINGLE_SURVEY_TEMPLATE_SUCCESS: 'Dfg/FETCH_SINGLE_SURVEY_TEMPLATE_SUCCESS',
    FETCH_SINGLE_SURVEY_TEMPLATE_FAILURE: 'Dfg/FETCH_SINGLE_SURVEY_TEMPLATE_FAILURE'
}
...
export function saveSurveyImages(data) {
    return action(types.SAVE_SURVEY_IMAGES, { data });
}
...
export function forceUpdateSurveyTemplates() {
    return action(types.FORCE_UPDATE_SURVEY_TEMPLATES);
}
...
export function toggleDownloadingSurveyDataModalVisibility(data) {
