...
function ListUserView(props) {
    ...
    const handleClick = () => {
        ...
        history.push('/admin/index/user/create');
    };

    //function for edit
    const editPressed = (rowData) => {
        let id = rowData[0];
        history.push(`/admin/index/user/${id}/details`);
    };
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            ...
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'firstName'), [passedColumns[1].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'lastName'), [passedColumns[2].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'username'), [passedColumns[3].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'email'), [passedColumns[4].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'mobile'), [passedColumns[5].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'role.name'), [passedColumns[6].columnName]);
                                }}
                            />
                        );
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <PickySelect
                                ...
                                dropdownHeight={600}
                                getFilterValue={val => {
                                    getDropdownFilterList(val, _.get(searchKeys, 'organization.name'), [passedColumns[7].columnName]);
                                }}
                            />
                        );
                    }
                        ...
                        return (
                            <>
                                ...
                                <PickySelect
                                    ...
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'userType.name'), [passedColumns[8].columnName]);
                                    }}
                                />
                            </>
                        );
    ...
    const showActionMenu = hasAccessPermission(RESOURCE_MAPPING.USER, ACTION_MAPPING.USER.EDIT_IN_ACTION) || hasAccessPermission(RESOURCE_MAPPING.USER, ACTION_MAPPING.USER.DELETE_IN_ACTION) || false;
    const showAddIcon = hasAccessPermission(RESOURCE_MAPPING.USER, ACTION_MAPPING.USER.ADD);
    if (showActionMenu) {
        let actions = {
            name: 'Actions',
            ...
            options: {
                ...
                customBodyRender: (value, tableMeta) => {
                    ...
                    let menuActions = [];
                    if (hasAccessPermission(RESOURCE_MAPPING.USER, ACTION_MAPPING.USER.EDIT_IN_ACTION) || false) {
                        menuActions.push({ name: I18n.t('edit'), fn: () => editPressed(rowData) });
                    }
                    if (hasAccessPermission(RESOURCE_MAPPING.USER, ACTION_MAPPING.USER.DELETE_IN_ACTION)) {
