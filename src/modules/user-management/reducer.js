...
import { ADDRESS_TYPES, REQUEST_STATUS, GENDER } from './constants';
...
const initialState = {
    ...
    assignOrganizationForUser: {
        ...
        requestInProgress: false,
        requestStatus: '',
        defaultOrganization: getEmptyPicky()
    },
    assignRoleForUser: {
        data: [],
        requestInProgress: false,
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ActionTypes.GET_USER_BY_ID_SUCCESS:
            return Object.assign({}, state, {
                singleUser: {
                    ...
                    requestInProgress: true,
                    loading: false,
                    singleUserOnly: getPayloadData(action.payload, {})
                }
            });
        ...
        case `User/${keys.COMMON_STATE}_SUCCESS`:
            return Object.assign({}, state, {
                states: {
                    data: getPayloadData(action.payload, []),
                    requestInProgress: false,
        ...
        case `User/${keys.COMMON_DISTRICT}_SUCCESS`:
            return Object.assign({}, state, {
                districts: {
                    data: getPayloadData(action.payload, []),
                    requestInProgress: false,
        ...
        case ActionTypes.LOAD_ORGANISATION_DETAILS_WITH_USER_ID_SUCCESS:
            return Object.assign({}, state, {
                ...
                assignOrganisation: {
                    ...
                    users: formatCheckBoxesFromAPI(getPayloadData(action.payload, {}).associations),
                    defaultOrganization: !isEmpty(getPayloadData(action.payload, {}).defaultOrganization) ? getPayloadData(action.payload, {}).defaultOrganization : getEmptyPicky()
                }
            });
        ...
        case ActionTypes.FETCH_ASSIGN_ORGANIZATION_FOR_USERS_SUCCESS: {
            ...
            return Object.assign({}, state, {
                assignOrganizationForUser: {
                    ...
                    defaultOrganization: assignOrgUsersResponse?.defaultOrganization || getEmptyPicky()
                }
            });
        }
        ...
        case ActionTypes.LIST_GENDER_SUCCESS:
            return Object.assign({}, state, {
                getGender: {
                    data: getPayloadData(action.payload, genderArray),
                    requestInProgress: false
                }
            });
