...
export function loadOrganisatiionWithUserId() {
    const type = 'dropdown';
    let payload = {
    ...
    return {
        url: URL.USER_MANAGEMENT.LOAD_ORG_LIST,
        api: restAPI.get,
        payload
    };
}
...
export function updateAssignOrganizationMapping({ userId, requestBody }) {
    ...
    return {
        url: URL.USER_MANAGEMENT.UPDATE_ASSIGN_ORGANIZATION.replace(':userId', userId),
        api: restAPI.put,
        payload
    };
}
...
export function submitUserRoleDataAccess({ userId, dataAccessRequest }) {
    let payload = {
        types: [ActionTypes.SUBMIT_USER_ROLE_DATA_ACCESS_REQUEST, ActionTypes.SUBMIT_USER_ROLE_DATA_ACCESS_SUCCESS, ActionTypes.SUBMIT_USER_ROLE_DATA_ACCESS_FAILURE],
        body: dataAccessRequest
    };
    return {
        url: URL.USER_MANAGEMENT.SAVE_USER_ROLE_DATA_ACCESS_PERMISSION.replace(':userId', userId),
        api: restAPI.put,
        payload
    };
}
