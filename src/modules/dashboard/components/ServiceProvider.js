        ...
        <>
            ...
            <Grid container spacing={2} style={{ marginBottom: '8px' }}>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('no_of_haritha_karma_sena')} subtitle='' icon='mdi-account-multiple'
                        content={{ count: 3400 }} color='color-brown' />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-cyan' title={I18n.t('no_of_supervisors')} icon='mdi-tools'
                        content={{ count: 4500 }} />
                </Grid>
