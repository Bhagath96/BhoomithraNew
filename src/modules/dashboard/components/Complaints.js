        ...
        <>
            ...
            <Grid container spacing={2} style={{ marginBottom: '8px' }}>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('complaints_total')} subtitle='' icon='mdi-account-multiple'
                        content={{ count: 270 }} color='color-lightblue' />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-lightgreen' title={I18n.t('complaints_resolved')} icon='mdi-tools'
                        content={{ count: 230 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-orange' title={I18n.t('complaints_not_rectified')} icon='mdi-currency-inr'
                        content={{ count: 40 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-grey' title={I18n.t('complaints_escalated')} icon='mdi-currency-inr'
                        content={{ count: 15 }} />
                </Grid>
            </Grid>
        </>
