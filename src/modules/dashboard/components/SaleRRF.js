        ...
        <>
            ...
            <Grid container spacing={2} style={{ marginBottom: '8px' }}>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('Total_Sale_LDPE')} subtitle={I18n.t('Plain_White')} icon='mdi-account-multiple'
                        content={{ count: 340 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-info' title={I18n.t('Total_Sale_LDPE')} subtitle={I18n.t('Print_Colour')} icon='mdi-tools'
                        content={{ count: 870 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-brown' title={I18n.t('Total_Sale_HDPE')} subtitle={I18n.t('Plain_White')} icon='mdi-currency-inr'
                        content={{ count: 300 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-red' title={I18n.t('Total_Sale_HDPE')} subtitle={I18n.t('Print_Colour')} icon='mdi-currency-inr'
                        content={{ count: 700 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-blueGrey' title={I18n.t('Total_Sale_Polypropylene_PP')} subtitle={I18n.t('White')} icon='mdi-currency-inr'
                        content={{ count: 2000 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('Total_Sale_Polypropylene_PP')} subtitle={I18n.t('Colour')} icon='mdi-currency-inr'
