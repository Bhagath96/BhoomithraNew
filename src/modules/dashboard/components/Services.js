        ...
        <>
            ...
            <Grid container spacing={2} style={{ marginBottom: '8px' }}>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('services_total')} subtitle='' icon='mdi-account-multiple'
                        content={{ count: 2500 }} color='color-grey' />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-lime' title={I18n.t('services_executed')} icon='mdi-tools'
                        content={{ count: 1800 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-orange' title={I18n.t('service_to_be_executed')} icon='mdi-currency-inr'
                        content={{ count: 700 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-blue' title={I18n.t('service_escalated')} icon='mdi-currency-inr'
                        content={{ count: 40 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-pink' title={I18n.t('service_cancelled')} icon='mdi-currency-inr'
                        content={{ count: 20 }} />
                </Grid>
            </Grid>
        </>
