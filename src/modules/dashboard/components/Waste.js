        ...
        <>
            ...
            <Grid container spacing={2} style={{ marginBottom: '8px' }}>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('total_waste_collected_plastic')} subtitle='' icon='mdi-account-multiple'
                        content={{ count: 340 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-info' title={I18n.t('total_waste_collected_glass')} icon='mdi-tools'
                        content={{ count: 870 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-brown' title={I18n.t('total_waste_collected_leather')} icon='mdi-currency-inr'
                        content={{ count: 300 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-red' title={I18n.t('total_waste_collected_e_waste')} icon='mdi-currency-inr'
                        content={{ count: 700 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-blueGrey' title={I18n.t('total_waste_collected_wet')} icon='mdi-currency-inr'
                        content={{ count: 2000 }} />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard title={I18n.t('manure_collected')} icon='mdi-currency-inr'
                        content={{ count: 100 }} color='color-lime' />
                </Grid>
                <Grid item lg={4} sm={4} xs={4} >
                    <CounterCard color='color-warning' title={I18n.t('poultry_waste')} icon='mdi-currency-inr'
                        content={{ count: 3000 }} />
                </Grid>
            </Grid>
        </>
