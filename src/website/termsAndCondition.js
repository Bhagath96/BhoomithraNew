...
function termsAndCondition() {
    ...
    return (
        <div style={{ backgroundColor: themePrimaryColor }}>
            <div className={classes.root}>
                <div className='container'>
                    <div className={classes.pageTitleContent}>
                        <h1 className={classes.headerTitle}>{i18n.t('terms_condition')}</h1>
                        <ul className={classes.headerTitleUl}>
                            ...
                            <li style={{ display: 'inline-block', position: 'relative', fontSize: '16px', paddingRight: '15px', marginLeft: '15px' }}>
                                <Link style={{ color: '#f68820' }} className={classes.a} to='/privacy'>{i18n.t('privacy-policy')}</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <Grid item xs={12} sm={12} md={12} style={{ backgroundColor: themePrimaryColor }}>
