...
function CreatePublicGatheringMethod(props) {
    ...
    useEffect(() => {
        if (id) {
            dispatch(Actions.getPublicGatheringMethodById(id));
        }
    }, [id]);
    ...
    const submit = (values) => {
        if (id) {
            dispatch(Actions.editPublicGatheringMethod(id, values));

        } else {
            dispatch(Actions.sentPublicGatheringMethod(values));
...
//     form: 'CreatePublicGatheringMethodForm',
//     enableReinitialize: true,

//     // validate
// })(CreatePublicGatheringMethod);
export default connect(state => ({
    initialValues: state[STATE_REDUCER_KEY].getPublicGatheringMethodById?.data
}))(reduxForm({
    form: 'CreatePublicGatheringMethodForm',
    enableReinitialize: true,
    validate
