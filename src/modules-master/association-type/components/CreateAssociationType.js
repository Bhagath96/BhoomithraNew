...
function CreateAssociationType(props) {
    ...
    useEffect(() => {
        if (id) {
            dispatch(Actions.getAssociationTypeById(id));
        }
    }, [id]);
    ...
    const submit = (values) => {
        if (id) {
            dispatch(Actions.editAssociationType(id, values));

        } else {
            dispatch(Actions.sentAssociationType(values));
...
//     form: 'CreateAssociationTypeForm',
//     enableReinitialize: true,

//     // validate
// })(CreateAssociationType);
export default connect(state => ({
    initialValues: state[STATE_REDUCER_KEY].getAssociationTypeById?.data
}))(reduxForm({
    form: 'CreateAssociationTypeForm',
    enableReinitialize: true,
    validate
