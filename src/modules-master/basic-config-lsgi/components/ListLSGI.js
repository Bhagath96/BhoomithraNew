...
function ListLSGI(props) {
    ...
    const passedColumns = [
        ...
        { columnLabel: 'district_panchayath', columnName: 'districtPanchayath', apiParam: 'districtPanNames', filterBy: 'name' },
        { columnLabel: 'lsgi_type', columnName: 'lsgiType', apiParam: 'orgTypeNames', filterBy: 'name' },
                        ...
                        return (
                            <>
                                ...
                                <PickySelect
                                    ...
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'lsgi.code'), [passedColumns[1].columnName]);
                                    }}
                                />
                            </>
                        );
                        ...
                        return (
                            <>
                                ...
                                <PickySelect
                                    ...
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'lsgi.districtLabel'), [passedColumns[1].columnName]);
                                    }}
                                />
                            </>
                        );
            ...
            options: {
                ...
                filterOptions: {
                    ...
                    display: (filterList, onChange, index, column) => {
                        return (
                            <>
                                <Typography variant='h7'>{[I18n.t('district_panchayath')]}</Typography>
                                <PickySelect
                                    id='district'
                                    name='district'
                                    ...
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'lsgi.districtPanchayathLabel'), [passedColumns[1].columnName]);
                                    }}
                                />
                            </>
                        );
                        ...
                        return (
                            <>
                                ...
                                <PickySelect
                                    ...
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'lsgi.organizationTypeLabel'), [passedColumns[1].columnName]);
                                    }}
                                />
                            </>
                        );
                        ...
                        return (
                            <>
                                ...
                                <PickySelect
                                    ...
                                    multiple={true}
                                    onChange={value => {
                                        setLsgiFilter({ [passedColumns[6].apiParam]: { value, property: [passedColumns[6].filterBy] } });
                                        filterList[index] = value.map(val => val.name);
                                        onChange(filterList[index], index, column);
                                    }}
                                    dropdownHeight={600}
                                    getFilterValue={val => {
                                        getDropdownFilterList(val, _.get(searchKeys, 'lsgi.blockPanchayathLabel'), [passedColumns[1].columnName]);
                                    }}
                                />
                            </>
                        );
